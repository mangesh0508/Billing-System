...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter) {
        ...
        add(tfphone);
        // entering new values/ updated values by the user 
        
        
        
        // taking values for the required field from database and presenting the existing values present in database
        try {
            Conn c = new Conn();
    ...
    // listening to buttons pressed and updating database
