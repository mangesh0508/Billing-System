    ...
    CalculateBill() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                // for listing all the meter numbers present in database
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            while(rs.next()) {
                ...
                // setting name and address according to meter number
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
            ...
            public void itemStateChanged(ItemEvent ie) {
                try {
                    ...
                    while(rs.next()) {
                        lblname.setText(rs.getString("name"));
                        labeladdress.setText(rs.getString("address"));
                        // changing name and address with change in meter number
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
