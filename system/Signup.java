...
// panel is a frame inside a frame
import javax.swing.*;
...
//        setSize(700,400);
//        setLocation(450,150);
        // use either of 2 upper of lower
        ...
        // to show meternumber and name only when customer is chosen
     ...
     public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == create) {
            ...
            try {
                Conn c = new Conn();
                // creating a Conn object to establish connection
                ...
                JOptionPane.showMessageDialog(null, "Account Created Successfully");                // if query executed successfully then this message will show
                setVisible(false);
                new Login();
            } catch (Exception e) {
                e.printStackTrace();
